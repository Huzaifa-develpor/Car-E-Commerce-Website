...
function openEdit(p) {
  ...
  // Save (Add or Edit)
   async function handleSave() {
    ...
    if (editId) {
      await axios.put(`http://localhost:5000/web/api/products/update/${editId}`, payload)
      .then(()=>{
        setProducts((prev)=>{
      ...
      // Add
        await axios.post('http://localhost:5000/web/api/products/additems',payload)
      .then((res)=>{
  ...
  async function handleDelete(id) {
    if (window.confirm("Do you want to delete this product?")) {
      await axios.delete(`http://localhost:5000/web/api/products/delete/${id}`)
      .then(()=>{
  ...
  async function toggleStatus(id) {
    await axios.put(`http://localhost:5000/web/api/products/updatestatus/${id}`)
    .then((res)=>{
