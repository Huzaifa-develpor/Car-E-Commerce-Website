...
export default function Products() {
  ...
  useEffect(()=>{
    axios.get("https://car-e-commerce-website-etvj.vercel.app/web/api/products/view")
    .then((res)=>{
...
function openEdit(p) {
  ...
  // Save (Add or Edit)
   async function handleSave() {
    ...
    if (editId) {
      await axios.put(`https://car-e-commerce-website-etvj.vercel.app/web/api/products/update/${editId}`, payload)
      .then(()=>{
        setProducts((prev)=>{
      ...
      // Add
        await axios.post('https://car-e-commerce-website-etvj.vercel.app/web/api/products/additems',payload)
      .then((res)=>{
  ...
  async function handleDelete(id) {
    if (window.confirm("Do you want to delete this product?")) {
      await axios.delete(`https://car-e-commerce-website-etvj.vercel.app/web/api/products/delete/${id}`)
      .then(()=>{
  ...
  async function toggleStatus(id) {
    await axios.put(`https://car-e-commerce-website-etvj.vercel.app/web/api/products/updatestatus/${id}`)
    .then((res)=>{
