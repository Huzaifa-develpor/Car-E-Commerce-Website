...
export default function Orders() {
  ...
  useEffect(() => {
    axios.get("https://car-e-commerce-website-etvj.vercel.app/web/api/auth/vieworders", {
  ...
  function updateStatus(id, newStatus) {
    axios.put(
      `https://car-e-commerce-website-etvj.vercel.app/web/api/auth/updatestatus/${id}`,
      { status: newStatus },
      { headers: { Authorization: `Bearer ${token}` } }
    )
    .then(() => {
