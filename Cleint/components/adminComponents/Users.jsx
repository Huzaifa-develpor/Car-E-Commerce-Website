...
export default function Users() {
  ...
  // Fetch users
  useEffect(() => {
    axios.get("https://car-e-commerce-website-etvj.vercel.app/web/api/auth/viewusers", {
      headers: {
  ...
  function removeUser(id) {
    if (window.confirm("Do you want to remove this user?")) {
      ...
      axios.delete(`https://car-e-commerce-website-etvj.vercel.app/web/api/auth/deleteuser/${id}`, {
        headers: {
          Authorization: `Bearer ${token}`
        }
      })
  ...
  function toggleStatus(id, currentStatus) {
    ...
    axios.put(
      `https://car-e-commerce-website-etvj.vercel.app/web/api/auth/updstatus/${id}`,
      { status: newStatus },
      {
        headers: {
          Authorization: `Bearer ${token}`
