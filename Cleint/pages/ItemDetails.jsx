...
const ItemDetails = () => {
  ...
  const addToCart = () => {
    ...
    axios.post('https://car-e-commerce-website-etvj.vercel.app/web/api/auth/addtocart', cartItem, {
  ...
  useEffect(() => {
    axios.get(`https://car-e-commerce-website-etvj.vercel.app/web/api/products/product/${id}`)
      .then((res) => {
